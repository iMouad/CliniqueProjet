            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card mb-4">
                ...
                <div class=card-body>
                  ...
                  <!--- --->
              <form method="post" action="add-admin-success">
                @csrf
                <!-- Username de l'admin -->
                 <div class="form-group w-50">
                     <label for="username">Username :</label>
                     <input type="text" class="form-control" id="username" name="username" aria-describedby="nameHelp" placeholder="L'username de l'administrateur" >
               ...
               <!-- Nom de l'admin -->
                <div class="form-group w-50">
                    ...
                    <input type="text" class="form-control" id="name" name="name" aria-describedby="nameHelp" placeholder="Le nom complet de l'administrateur" v>
                ...
                <div class="form-group w-50">
                    ...
                    <input type="text" class="form-control" id="email" name="email" placeholder="l'email de l'administrateur">
                </div>
                @if($errors->has('email'))
                <div class="alert alert-danger w-50" role="alert">
                  {{ $errors->first('email') }}
                ...
                <div class="form-group w-50">
                    ...
                    <input type="password" class="form-control" id="password" name="password" placeholder="Entrez le mot de passe" value="">
                    <small id="nameHelp" class="form-text text-muted">le mot de passe doit contenir au moins 8 caractères</small>
                </div>
